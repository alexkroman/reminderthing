...
$( document ).ready( function() {
    ...
    $( document ).keydown( function( e ) {
        // bind ESC
        if( e.which == KEY_ESCAPE ) hide_all_calendars()
    });
})
...
function DatePicker( date_picker ) {
    ...
    DatePicker.prototype.attach = function() {
        ...
        self.month_control()
            .keydown( function( e ) { self.capture_manual_entry( e, 'm' ) })
            .click( function( e ) { self.update_from_manual_controls( false, 'm' ) })
        self.date_control()
            .keydown( function( e ) { self.capture_manual_entry( e, 'd' ) })
            .click( function( e ) { self.update_from_manual_controls( false, 'd' ) })
        self.year_control()
            .keydown( function( e ) { self.capture_manual_entry( e, 'y' ) })
    ...
    DatePicker.prototype.capture_manual_entry = function( e, control_type ) {
        ...
        else if(( e.which != KEY_TAB ) && ( e.which != KEY_ENTER ) && ( e.which != KEY_DASH ) && ( e.which != KEY_SLASH )) {
            e.preventDefault()
            return false
        }
